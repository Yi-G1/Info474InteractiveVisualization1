...
console.log("world2019datamid",world2019datamid);
let world2019dataPos = world2019datamid.filter(item => {return item.Value >0})
console.log("world2019dataPos",world2019dataPos);
  ...
  render() {
      ...
      return (
        <svg height = "500" width = "500" viewBox="0 0 500 500" className = 'graph6'>
          <circle className='first' stroke-dasharray=" 1570.8 1570.8"></circle>
